...
| Resource | Link |
|---|---|
| 📓 Notebook | [mlops_model_tournament.ipynb](notebooks/mlops_model_tournament.ipynb) |
| 📊 HTML Report | [tournament_report.html](reports/tournament_report.html) |
| 📈 Comparison Chart | [tournament_comparison.png](reports/tournament_comparison.png) |
| 🔴 ROC — RandomForest | [roc_RandomForest.png](reports/roc_RandomForest.png) |
| 🔴 ROC — LightGBM | [roc_LightGBM.png](reports/roc_LightGBM.png) |
| 🔴 ROC — CatBoost | [roc_CatBoost.png](reports/roc_CatBoost.png) |
| 🔴 ROC — XGBoost | [roc_XGBoost.png](reports/roc_XGBoost.png) |
| 🔴 ROC — LogisticRegression | [roc_LogisticRegression.png](reports/roc_LogisticRegression.png) |
| 🟦 Confusion Matrix — RandomForest | [cm_RandomForest.png](reports/cm_RandomForest.png) |
| 🟦 Confusion Matrix — LightGBM | [cm_LightGBM.png](reports/cm_LightGBM.png) |
| 🟦 Confusion Matrix — CatBoost | [cm_CatBoost.png](reports/cm_CatBoost.png) |
| 🟦 Confusion Matrix — XGBoost | [cm_XGBoost.png](reports/cm_XGBoost.png) |
| 🟦 Confusion Matrix — LogisticRegression | [cm_LogisticRegression.png](reports/cm_LogisticRegression.png) |
| ⚙️ CI/CD Workflow | [tournament.yml](.github/workflows/tournament.yml) |
| 📋 Source Code | [src/tournament.py](src/tournament.py) |
| 🧪 Unit Tests | [tests/test_tournament.py](tests/test_tournament.py) |
| 📦 Requirements | [requirements.txt](requirements.txt) |
| 🗃️ Dataset Source | [UCI Bank Marketing — Kaggle](https://www.kaggle.com/datasets/henriqueyamahata/bank-marketing) |
| 📰 Original Paper | [Moro et al., 2014 — UCI ML Repository](https://archive.ics.uci.edu/dataset/222/bank+marketing) |
...
**Why `duration` is dropped:** Call duration is unknown before the call is made — using it causes data leakage. Documented in [`src/data/loader.py`](src/data/loader.py) and flagged as a warning at runtime.
...
├── notebooks/
│   └── mlops_model_tournament.ipynb   # Full EDA + tournament notebook
├── tests/
...
jupyter notebook notebooks/mlops_model_tournament.ipynb
```
...
[![Tournament Comparison](reports/tournament_comparison.png)](reports/tournament_comparison.png)
...
> All four gradient boosting models cluster tightly between AUC 0.813–0.817 — meaningful separation will come from hyperparameter tuning in **[Project 4 (Optuna)](https://github.com/jumma786/mlops-hyperparameter-tuning)**. The value here is the *pipeline infrastructure*, not absolute metric numbers.
...
| # | Project | Repo | Status |
|---|---|---|---|
| **1** | **Multi-Model Tournament** | [mlops-model-tournament](https://github.com/jumma786/mlops-model-tournament) | ✅ This repo |
